...
// EventFungibleTransfer is emitted by the chain bridge when a fungible token transfer is executed
...
// EventNonFungibleTransfer is emitted by the chain bridge when a non fungible token transfer is executed
...
// EventGenericTransfer is emitted by the chain bridge when a generic transfer is executed
...
// EventChainWhitelisted is emitted by the chain bridge when a new chain is whitelisted
...
// EventRelayerAdded is emitted by the chain bridge when a new relayer is whitelisted
...
// EventRelayerThresholdChanged is emitted by the chain bridge when a the relayer threshold is changed
...
// EventRelayerRemoved is emitted by the chain bridge when a relayer is removed
